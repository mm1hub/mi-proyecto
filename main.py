...
class GameController:
    ...
    def initialize(self) -> bool:
        ...
        # No inicializamos el ecosistema aquí: se hace al presionar "Comenzar"
    ...
    def execute_turn(self):
        ...
        La lógica de IA ya está integrada en Ecosystem.update().
        Este método marca el momento discreto del turno para la barra de UI.
        """
        pass
